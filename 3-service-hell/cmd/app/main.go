...
import (
	...
	"github.com/golang-school/evolution/3-service-hell/internal/message_service"

	"github.com/golang-school/evolution/3-service-hell/config"
	...
	"github.com/golang-school/evolution/3-service-hell/internal/server"
...
func AppRun(ctx context.Context, c config.Config) error {
	...
	// MessageService
	messageService := message_service.NewMessageService(kafkaProducer)

	// ProfileService
	profileService := profile_service.NewProfile(pgPool, messageService, redisClient)
